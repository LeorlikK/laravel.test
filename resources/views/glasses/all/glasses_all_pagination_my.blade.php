...
<!-- body -->
<body class="test text main-layout position_head">
<!-- loader  -->
<div class="loader_bg">
...
<div class="glasses">
    ...
    <div class="container-fluid">
        ...
        <form action="" method="get">
            ...
            <a href="{{ route('get_all') }}"><button type="submit">Find</button></a>
            ...
            <div>
                ...
                <select multiple name="sorted_select[]" id="selector_sorted"> // name="sorted_select[]"
                    <option
                        ...
                        selected>{{isset($filter['sorted_select']) ? "Filter by:" . str(...$filter['sorted_select']) : '...'}}</option>
...
{{--                        selected> {{ "Filter by:" . $brands->where('id', $filter['brand_select'])->pluck('name')  ?? '...'}}--}}
        ...
        <div class="row">
            ...
            @foreach($data as $item)
                ...
                <div class="col-md-12">
                    <a class="read_more" href="{{ route('glasses_read', [$item->id, $data->currentPage()]) }}">Read More</a>
                </div>
            @endforeach
            @endif
        </div>
        ...
        <nav aria-label="...">
            <ul class="pagination">
                ...
                <li class="page-item active">
                    <a class="page-link" href="#">{{ $data->currentPage() }} <span class="sr-only">(current)</span></a>
                </li>
